	...
	<div class="container">
		...
		<div class="column-60">
			...
			<form action="/api/registry" method="post">
				...
				<a href="javascript:document.getElementById('period').value=60;" class="button button-outlined float-right">Hourly</a>
				<a href="javascript:document.getElementById('period').value=24*60;" class="button button-outlined float-right">Daily</a>
				<a href="javascript:document.getElementById('period').value=24*60*7;" class="button button-outlined float-right">Weekly</a>
